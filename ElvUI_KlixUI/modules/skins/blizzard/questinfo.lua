...
local function QuestInfo_GetQuestID()
	...
	local waypointText = T.C_QuestLog_GetNextWaypointText(questID)
...
local function styleQuestInfo()
	...
	for _, name in T.next, {"HonorFrame", "MoneyFrame", "SkillPointFrame", "XPFrame", "ArtifactXPFrame", "TitleFrame", "WarModeBonusFrame"} do
		RestyleRewardButton(_G.MapQuestInfoRewardsFrame[name], true)
	end

	for _, name in T.next, {"HonorFrame", "SkillPointFrame", "ArtifactXPFrame", "WarModeBonusFrame"} do
