...
function KC:HideChatFade()
	local fadeOutTime = E.db.KlixUI.chat.chatFade.fadeOutTime or 0.65

	E:UIFrameFadeOut(self.fadeParent, fadeOutTime, self.fadeParent:GetAlpha(), E.db.KlixUI.chat.chatFade.minAlpha)
end
