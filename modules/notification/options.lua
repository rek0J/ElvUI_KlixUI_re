			...
			general = {
				...
				args = {
					...
					noSound = {
						...
						disabled = function() return not E.db.KlixUI.notification.enable end,
						hidden = function() return not E.db.KlixUI.notification.enable end,
						set = function(info, value) E.db.KlixUI.notification.noSound = value end,
					},
					message = {
						order = 8,
						type = "toggle",
						...
						disabled = function() return not E.db.KlixUI.notification.enable end,
						hidden = function() return not E.db.KlixUI.notification.enable end,
						set = function(info, value) E.db.KlixUI.notification.message = value end,
					},
					mail = {
						order = 9,
						type = "toggle",
						...
						disabled = function() return not E.db.KlixUI.notification.enable end,
						hidden = function() return not E.db.KlixUI.notification.enable end,
						set = function(info, value) E.db.KlixUI.notification.mail = value end,
					},
					vignette = {
						order = 10,
						type = "toggle",
						...
						disabled = function() return not E.Retail or not E.db.KlixUI.notification.enable end,
						hidden = function() return not E.Retail or not E.db.KlixUI.notification.enable end,
						set = function(info, value) E.db.KlixUI.notification.vignette = value end,
					},
					invites = {
						order = 11,
						type = "toggle",
						...
						disabled = function() return not E.db.KlixUI.notification.enable end,
						hidden = function() return not E.db.KlixUI.notification.enable end,
						set = function(info, value) E.db.KlixUI.notification.invites = value end,
					},
					guildEvents = {
						order = 12,
						type = "toggle",
						...
						disabled = function() return not E.db.KlixUI.notification.enable end,
						hidden = function() return not E.db.KlixUI.notification.enable end,
						set = function(info, value) E.db.KlixUI.notification.guildEvents = value end,
					},
					quickJoin = {
						order = 13,
						type = "toggle",
						...
						disabled = function() return not E.Retail or not E.db.KlixUI.notification.enable end,
						hidden = function() return not E.Retail or not E.db.KlixUI.notification.enable end,
						set = function(info, value) E.db.KlixUI.notification.quickJoin = value end,
					},
				},
			},
		},
