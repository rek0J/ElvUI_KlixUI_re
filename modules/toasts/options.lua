	...
	E.Options.args.KlixUI.args.modules.args.toasts = {
		...
		args = {
			...
			hold_on_mouseover = {
				order = 8,
				type = "toggle",
				name = "Hold On Mouseover",
				desc = "Pause toast fadeout while the toast or its rewards are hovered.",
				disabled = function() return not E.db.KlixUI.toasts.enable end,
			},
			scale = {
				order = 9,
				...
				args = {
					achievement = {
						...
						args = {
							...
							achievement_icon_source = {
								order = 3,
								type = "select",
								name = "Achievement Icon Source",
								values = {
								...
								disabled = function() return not E.db.KlixUI.toasts.achievement_enabled end,
								get = function(info) return E.db.KlixUI.toasts.achievement_icon_source end,
								set = function(info, value) E.db.KlixUI.toasts.achievement_icon_source = value; end,
							},
							use_mop_fallback_icons = {
								order = 4,
								type = "toggle",
								name = "Use MoP Fallback Icons",
								desc = "Use safe MoP-compatible fallback icons when the requested achievement icon is missing or invalid.",
								disabled = function() return not E.db.KlixUI.toasts.achievement_enabled end,
								get = function(info) return E.db.KlixUI.toasts.use_mop_fallback_icons end,
								set = function(info, value) E.db.KlixUI.toasts.use_mop_fallback_icons = value; end,
							},
						},
					},
					archaeology = {
