...
local function SkinPlayerChoice()
	if not (E.private.skins.blizzard.enable and E.private.skins.blizzard.playerChoice) or E.private.KlixUI.skins.blizzard.playerChoice ~= true then return end
...
S:AddCallbackForAddon("Blizzard_PlayerChoiceUI", "KuiPlayerChoice", SkinPlayerChoice)
