...
local function styleSoulbinds()
	if not (E.private.skins.blizzard.enable and E.private.skins.blizzard.soulbinds) or E.private.KlixUI.skins.blizzard.soulbinds ~= true then return end
...
S:AddCallbackForAddon('Blizzard_Soulbinds', "KuiSoulbinds", styleSoulbinds)
