...
local function styleArtifact()
	if E.private.skins.blizzard.enable ~= true or E.private.skins.blizzard.artifact ~= true or E.private.KlixUI.skins.blizzard.artifact ~= true then return end
	...
	_G.ArtifactFrame.AppearancesTab:HookScript("OnShow", function(self)
		for i = 1, self:GetNumChildren() do
			local child = T.select(i, self:GetChildren())
...
S:AddCallbackForAddon("Blizzard_ArtifactUI", "KuiArtifact", styleArtifact)