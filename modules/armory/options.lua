...
local function GetElvUIItemLevelOptions()
	local general = E.Options and E.Options.args and E.Options.args.general and E.Options.args.general.args
	local improvements = general and general.blizzUIImprovements
	local itemLevelInfo = improvements and improvements.args and improvements.args.itemLevelInfo
	return itemLevelInfo and itemLevelInfo.args
end
	...
	E.Options.args.KlixUI.args.modules.args.armory = {
		...
		args = {
			...
			gotoarmory = {
				...
				type = "execute",
				name = L["ElvUI Armory"],
				disabled = function() return not GetElvUIItemLevelOptions() end,
				func = function()
					if GetElvUIItemLevelOptions() then
						LibStub("AceConfigDialog-3.0-ElvUI"):SelectGroup("ElvUI", "general", "blizzUIImprovements")
					end
				end,
			},
			space2 = {
...
local function injectElvUIArmoryOptions()
	local itemLevelOptions = GetElvUIItemLevelOptions()
	if not itemLevelOptions then return end

	itemLevelOptions.displayCharacterInfo = {
		order = 1,
		type = "toggle",
