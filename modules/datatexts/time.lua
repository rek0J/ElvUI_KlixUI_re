...
local GetNumWorldPVPAreas = T.GetNumWorldPVPAreas or _G.GetNumWorldPVPAreas
local GetWorldPVPAreaInfo = T.GetWorldPVPAreaInfo or _G.GetWorldPVPAreaInfo
...
local function OnEnter(self)
	...
	if GetWorldPVPAreaInfo and type(numAreas) == "number" then
		for i = 1, numAreas do
