...
function AP:BuildFrame()
	...
	Search:SetSize(1, 20)
	Search:CreateBackdrop("Transparent")
	...
	Search:HookScript('OnEditFocusGained', function(self) self.backdrop:SetBackdropBorderColor(T.unpack(AP.db['ClassColor'] and AP.ClassColor or AP.db['CheckColor'])) self:HighlightText() end)
	Search:HookScript('OnEditFocusLost', function(self) self:CreateBackdrop() self:HighlightText(0, 0) end)
	...
	Reload:CreateBackdrop("Transparent")
	Reload:SetSize(70, 20)
	Reload:SetScript('OnEnter', function(self) self.backdrop:SetBackdropBorderColor(unpack(AP.db['ClassColor'] and AP.ClassColor or AP.db['CheckColor'])) end)
	Reload:SetScript('OnLeave', function(self) self:CreateBackdrop() end)
	...
	CharacterSelect:CreateBackdrop()
	CharacterSelect:SetScript('OnEnter', function(self) self.backdrop:SetBackdropBorderColor(unpack(AP.db['ClassColor'] and AP.ClassColor or AP.db['CheckColor'])) end)
	CharacterSelect:SetScript('OnLeave', function(self) self:CreateBackdrop() end)
	...
	Profiles:CreateBackdrop()
	Profiles:SetSize(70, 20)
	Profiles:SetScript('OnEnter', function(self) self.backdrop:SetBackdropBorderColor(T.unpack(AP.db['ClassColor'] and AP.ClassColor or AP.db['CheckColor'])) end)
	Profiles:SetScript('OnLeave', function(self) self:CreateBackdrop() end)
	...
	AddOns:CreateBackdrop()
	AddOns.Buttons = {}
	AddOns:EnableMouse(true)
	AddOns:EnableMouseWheel(true)
	AddOns:CreateBackdrop("Transparent")
	...
	for i = 1, 30 do
		...
		CheckButton:CreateBackdrop("Transparent")
		...
		CheckButton:SetScript('OnEnter', function(self)
			...
			GameTooltip:Show()
			self.backdrop:SetBackdropBorderColor(unpack(AP.db['ClassColor'] and AP.ClassColor or AP.db['CheckColor']))
		end)
		CheckButton:SetScript('OnLeave', function(self) self:CreateBackdrop() GameTooltip:Hide() end)
...
function AP:InitProfiles()
	...
	ProfileMenu:CreateBackdrop('Transparent')
	ProfileMenu:Hide()
	ProfileMenu:Styling()
	...
	for _, name in T.pairs({'EnableAll', 'DisableAll', 'NewButton'}) do
		...
		Button:SetScript('OnEnter', function(self) self.backdrop:SetBackdropBorderColor(unpack(AP.db['ClassColor'] and AP.ClassColor or AP.db['CheckColor'])) end)
		Button:SetScript('OnLeave', function(self) self:CreateBackdrop() end)
	...
	for i = 1, 10 do
		...
		for _, Frame in T.pairs({'Load', 'Delete', 'Update'}) do
			...
			Button:SetScript('OnEnter', function(self) self.backdrop:SetBackdropBorderColor(T.unpack(AP.db['ClassColor'] and AP.ClassColor or AP.db['CheckColor'])) end)
			Button:SetScript('OnLeave', function(self) self:CreateBackdrop() end)
