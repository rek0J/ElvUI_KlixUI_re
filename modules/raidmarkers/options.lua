	...
	E.Options.args.KlixUI.args.modules.args.raidmarkers = {
		...
		args = {
			...
			automark = {
				...
				type = "group",
				name = L["Auto Mark"],
				disabled = function() return T.IsAddOnLoaded("DejaAutoMark") end,
				hidden = function() return T.IsAddOnLoaded("DejaAutoMark") end,
				get = function(info) return E.db.KlixUI.raidmarkers.automark[ info[#info] ] end,
				set = function(info, value) E.db.KlixUI.raidmarkers.automark[ info[#info] ] = value; RMA:AutoMark() end,
				args = {
					enable = {
						order = 1,
						type = "toggle",
					...
					tankMark = {
						...
						type = "select",
						name = L["Tank Mark"],
						disabled = function() return not E.db.KlixUI.raidmarkers.automark.enable end,
						values = {
							[1] = L["Star"],
							[2] = L["Circle"],
							[3] = L["Diamond"],
