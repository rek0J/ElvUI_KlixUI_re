...
COMP.WIND = KUI:IsAddOnEnabled('ElvUI_WindTools')
COMP.LIVVEN = KUI:IsAddOnEnabled('ElvUI_LivvenUI')
...
function COMP:WindToolsCompatibility()
	...
	if COMP.WIND and WIND then
		E:StaticPopup_Show("WINDTOOLS_KUI_INCOMPATIBLE")
		return true
	end
end
...
function COMP:LivvenCompatibility()
	...
	if COMP.LIVVEN and LIVVEN then
		E:StaticPopup_Show("LIVVEN_KUI_INCOMPATIBLE")
		return true
	end
end
